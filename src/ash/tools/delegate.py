...
class DelegateAgentsTool(BaseTool):
    ...
    async def run(self, **kwargs: Any) -> ToolResult:
        ...
        for spec in args.tasks:
            ...
            if unknown:
                return _error(
                    f"Task {spec.key!r} has unknown dependencies: " + ", ".join(unknown)
                )
            ...
            if (
                ...
                and spec.time_budget_seconds > self._config.agent_time_budget_seconds
            ):
                return _error(
        ...
        definitions = [
            AgentTaskCreate(
                ...
                time_budget_seconds=(
                    spec.time_budget_seconds or self._config.agent_time_budget_seconds
                ),
                metadata={
