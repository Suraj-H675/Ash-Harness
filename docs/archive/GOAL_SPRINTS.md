...
*   **Specifications Referenced**:
    - [ASH_MASTER_PLAN_V2.md](ASH_MASTER_PLAN_V2.md) (Section 16: File Structure)
    - [ARCHITECTURAL_SPECIFICATION.md](ARCHITECTURAL_SPECIFICATION.md) (Section 2.7: Configuration Settings)
...
*   **Specifications Referenced**:
    - [ARCHITECTURAL_SPECIFICATION.md](ARCHITECTURAL_SPECIFICATION.md) (Section 2.2: Session Persistence, Section 3: Database Schema)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [ARCHITECTURAL_SPECIFICATION.md](ARCHITECTURAL_SPECIFICATION.md) (Section 2.6: Safety Guard)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [TOOL_SPECIFICATIONS.md](../reference/TOOL_SPECIFICATIONS.md) (Section 1: Tool Base, Section 2: Core Tool Definitions, Section 4: Platform-Specific Command Safety)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [CONTEXT_AND_MEMORY_SPECIFICATION.md](../architecture/CONTEXT_AND_MEMORY_SPECIFICATION.md) (Section 3: Token Counting & Rate Limiting)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [CONTEXT_AND_MEMORY_SPECIFICATION.md](../architecture/CONTEXT_AND_MEMORY_SPECIFICATION.md) (Section 5: Semantic Memory & FTS5 Lookup)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [SYSTEM_PROMPTS_AND_TEMPLATES.md](../architecture/SYSTEM_PROMPTS_AND_TEMPLATES.md) (Section 3: Core XML Tagging Specifications)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [ARCHITECTURAL_SPECIFICATION.md](ARCHITECTURAL_SPECIFICATION.md) (Section 2.1: Core Loop, Section 2.5: Provider, Section 4: Sequence Diagram)
    - [SYSTEM_PROMPTS_AND_TEMPLATES.md](../architecture/SYSTEM_PROMPTS_AND_TEMPLATES.md) (Section 1: Primary System Prompt, Section 2: Mode-Specific Prompts)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [CONTEXT_AND_MEMORY_SPECIFICATION.md](../architecture/CONTEXT_AND_MEMORY_SPECIFICATION.md) (Section 4: Repository Mapping)
    - [TOOL_SPECIFICATIONS.md](../reference/TOOL_SPECIFICATIONS.md) (Section 2.6: Git Tools)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [CONTEXT_AND_MEMORY_SPECIFICATION.md](../architecture/CONTEXT_AND_MEMORY_SPECIFICATION.md) (Section 5: Semantic Memory & FTS5 Lookup Pipeline)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [TOOL_SPECIFICATIONS.md](../reference/TOOL_SPECIFICATIONS.md) (Section 2.5: run_command Security Policies)
    - [ASH_MASTER_PLAN_V2.md](ASH_MASTER_PLAN_V2.md) (Version 4 roadmap)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [SYSTEM_PROMPTS_AND_TEMPLATES.md](../architecture/SYSTEM_PROMPTS_AND_TEMPLATES.md) (Section 2.1: Architect Mode Prompt)
    - [ASH_MASTER_PLAN_V2.md](ASH_MASTER_PLAN_V2.md) (Version 5 roadmap)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [ARCHITECTURAL_SPECIFICATION.md](ARCHITECTURAL_SPECIFICATION.md) (Section 3.3: Subagent Shared State Schema)
    - [ASH_MASTER_PLAN_V2.md](ASH_MASTER_PLAN_V2.md) (Version 6 roadmap)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [ASH_MASTER_PLAN_V2.md](ASH_MASTER_PLAN_V2.md) (Version 7 roadmap)
*   **Prompt to Copy/Paste**:
    ```markdown
...
*   **Specifications Referenced**:
    - [ASH_MASTER_PLAN_V2.md](ASH_MASTER_PLAN_V2.md) (Section 14: Testing Strategy)
*   **Prompt to Copy/Paste**:
    ```markdown
