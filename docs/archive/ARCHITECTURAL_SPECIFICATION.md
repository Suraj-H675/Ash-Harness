...
### 2.1 Core Loop (`src/ash/core/loop.py`)
...
### 2.2 Session Persistence (`src/ash/core/session.py`)
...
### 2.3 Context Builder (`src/ash/core/context.py`)
...
### 2.4 Recovery & Circuit Breaker (`src/ash/core/recovery.py`)
...
### 2.5 Provider Interface (`src/ash/providers/base.py`)
...
### 2.6 Safety Guard (`src/ash/safety/guard.py`)
...
### 2.7 Configuration Settings (`src/ash/config.py`)
