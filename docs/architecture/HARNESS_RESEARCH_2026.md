...
| Isolated profiles | missing | implemented | implemented | unknown | Ash records profiles as remaining work in this architecture record; Hermes [profiles](https://hermes-agent.nousresearch.com/docs/user-guide/profiles); OpenClaw [multi-agent workspaces and routing](https://docs.openclaw.ai/concepts/multi-agent); no qualifying OpenCode harness-profile evidence found | 2026-08-30 | missing |
